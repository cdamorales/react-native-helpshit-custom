...
public class RNHelpshiftModule extends ReactContextBaseJavaModule implements Support.Delegate {
    ...
    public void init(String key, String domain, String appid) throws InstallException {
        ...
        try{
            ...
            Log.e("ERROR, ", "invalid install credentials : ", e);
        }
    }
    ...
    @ReactMethod
    public void newConversationWithMessage(String newConversationMessage, String messageError, String pantallaActual) {
        String[] tags;
            tags = new String[] { "Error Técnico: " + messageError, "Pantalla: " + pantallaActual };
        final Activity activity = getCurrentActivity();
        ...
        config.put("conversationPrefillText", newConversationMessage);
    ...
    @Override
    public void userClickOnAction(ActionType actionType, String label){
